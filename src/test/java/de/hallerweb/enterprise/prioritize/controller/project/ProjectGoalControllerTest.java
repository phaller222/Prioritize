...
class ProjectGoalControllerTest {
    ...
    void setUp() {
        ...
        controller = new ProjectGoalController(projectGoalService);
    }
    ...
    void createGoal_created() {
        ...
        ResponseEntity<ProjectGoalDTO> response = controller.createGoal(
                3L, new GoalRequest("Cool it", "d", null), user);
    ...
    void createGoal_blankName_throws() {
        assertThrows(IllegalArgumentException.class, () -> controller.createGoal(
                3L, new GoalRequest("", "d", null), user));
    ...
    void getProgress_delegates() {
        ...
        ResponseEntity<ProjectProgress> response = controller.getProgress(7L, user);
    ...
    void deleteGoal_noContent() {
        ResponseEntity<Void> response = controller.deleteGoal(3L, 9L, user);
