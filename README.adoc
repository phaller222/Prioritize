...
Prioritize is an open source Spring-based Framework to accomplish basically the following tasks:
...
It can be installed and run as a Spring-Application standalone or in a Docker container.
...
**Blackboard** -				Implements the concept of a blackboard. All tasks of a project can be picked by user or resources.
